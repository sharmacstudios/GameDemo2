...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Escape Webgl 1.data';
    var REMOTE_PACKAGE_BASE = 'Escape Webgl 1.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 6000784;
      var PACKAGE_UUID = '5c0e689d-b0a7-48b9-8aaa-860ce3d40f66';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 3193871, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(3193871, 3193890, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(3193890, 4477858, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(4477858, 5973158, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(5973158, 6000784, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Escape Webgl 1.data');

    };
    Module['addRunDependency']('datafile_Escape Webgl 1.data');
